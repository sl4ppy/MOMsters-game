...
export class CollisionManager {
   ...
   */
  addCollisionPair(groupA: CollisionGroup, groupB: CollisionGroup, callback?: (entityA: Collidable, entityB: Collidable) => void): void {
  ...
  private shouldCollide(groupA: CollisionGroup, groupB: CollisionGroup): CollisionPair | null {
    return this.collisionPairs.find(pair => 
