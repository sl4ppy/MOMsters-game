...
export class EnemySpriteManager {
  ...
  private readonly enemyConfigs: EnemySpriteConfig[] = [
    ...
    { id: 3, name: 'Hobgoblin', health: 35, speed: 85, damage: 10, collisionRadius: 13, xpValue: 8 },
    { id: 4, name: 'Mermaid', health: 30, speed: 95, damage: 9, collisionRadius: 11, xpValue: 6 },
    { id: 5, name: 'Gargoyle', health: 45, speed: 70, damage: 12, collisionRadius: 14, xpValue: 10 },
    { id: 6, name: 'ChompChest', health: 60, speed: 50, damage: 15, collisionRadius: 16, xpValue: 12 },
    ...
    { id: 9, name: 'Palomino', health: 40, speed: 100, damage: 11, collisionRadius: 13, xpValue: 8 },
    
    // Row 2 (10-19): Medium enemies
    { id: 10, name: 'Green Dragon', health: 120, speed: 75, damage: 25, collisionRadius: 20, xpValue: 30 },
    { id: 11, name: 'Red Dragon', health: 150, speed: 70, damage: 30, collisionRadius: 22, xpValue: 40 },
    { id: 12, name: 'Blue Dragon', health: 180, speed: 65, damage: 35, collisionRadius: 24, xpValue: 50 },
    { id: 13, name: 'Skeleton', health: 30, speed: 85, damage: 10, collisionRadius: 12, xpValue: 8 },
    { id: 14, name: 'Mollusk', health: 25, speed: 55, damage: 8, collisionRadius: 10, xpValue: 6 },
    { id: 15, name: 'Banshee', health: 35, speed: 90, damage: 12, collisionRadius: 12, xpValue: 10 },
    { id: 16, name: 'Floating Maw', health: 50, speed: 80, damage: 16, collisionRadius: 14, xpValue: 14 },
    { id: 17, name: 'Cacodemon', health: 70, speed: 75, damage: 20, collisionRadius: 16, xpValue: 18 },
    { id: 18, name: 'Sea Hag', health: 40, speed: 85, damage: 13, collisionRadius: 13, xpValue: 10 },
    { id: 19, name: 'Demon', health: 80, speed: 85, damage: 22, collisionRadius: 17, xpValue: 20 },
    
    // Row 3 (20-29): Elite enemies
    { id: 20, name: 'Centaur', health: 65, speed: 95, damage: 18, collisionRadius: 15, xpValue: 16 },
    { id: 21, name: 'Green Orc', health: 55, speed: 80, damage: 15, collisionRadius: 14, xpValue: 12 },
    { id: 22, name: 'Golden Orc', health: 75, speed: 75, damage: 20, collisionRadius: 16, xpValue: 18 },
