...
export class ChompChestEnemy extends Enemy {
  ...
  constructor(enemySpriteManager: EnemySpriteManager) {
    ...
    const baseConfig = enemySpriteManager.getEnemyConfig(6) || {
      health: 60, speed: 50, damage: 15, collisionRadius: 16, xpValue: 12
    }
  ...
  private createFallbackSprite(): void {
    ...
    graphics.drawRoundedRect(-this.collisionRadius, -this.collisionRadius, 
                           this.collisionRadius * 2, this.collisionRadius * 2, 4)
    graphics.endFill()
